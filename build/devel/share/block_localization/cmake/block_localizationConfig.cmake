...
if(block_localization_CONFIG_INCLUDED)
  return()
endif()
set(block_localization_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(block_localization_SOURCE_PREFIX /home/yixin/icra_ws/src/Block-Map-Based-Localization)
  set(block_localization_DEVEL_PREFIX /home/yixin/icra_ws/src/Block-Map-Based-Localization/build/devel)
  set(block_localization_INSTALL_PREFIX "")
  set(block_localization_PREFIX ${block_localization_DEVEL_PREFIX})
else()
  set(block_localization_SOURCE_PREFIX "")
  set(block_localization_DEVEL_PREFIX "")
  set(block_localization_INSTALL_PREFIX /usr/local)
  set(block_localization_PREFIX ${block_localization_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'block_localization' is deprecated")
...
set(block_localization_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/yixin/icra_ws/src/Block-Map-Based-Localization/build/devel/include;/home/yixin/icra_ws/src/Block-Map-Based-Localization/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(block_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/yixin/icra_ws/src/Block-Map-Based-Localization/build/devel/include;/home/yixin/icra_ws/src/Block-Map-Based-Localization/include;/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Yixiao Feng <yixiao.feng@student.unsw.edu.au>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${block_localization_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'block_localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'block_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yixin/icra_ws/src/Block-Map-Based-Localization/${idir}'.  ${_report}")
    endif()
    _list_append_unique(block_localization_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND block_localization_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND block_localization_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT block_localization_NUM_DUMMY_TARGETS)
      set(block_localization_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::block_localization::wrapped-linker-option${block_localization_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR block_localization_NUM_DUMMY_TARGETS "${block_localization_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::block_localization::wrapped-linker-option${block_localization_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND block_localization_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yixin/icra_ws/src/Block-Map-Based-Localization/build/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(block_localization_LIBRARY_DIRS ${lib_path})
      list(APPEND block_localization_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'block_localization'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND block_localization_LIBRARIES ${lib})
    endif()
  endif()
...
set(block_localization_EXPORTED_TARGETS "block_localization_generate_messages_cpp;block_localization_generate_messages_eus;block_localization_generate_messages_lisp;block_localization_generate_messages_nodejs;block_localization_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${block_localization_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;rospy;actionlib;tf;std_msgs;nav_msgs;geometry_msgs;sensor_msgs;message_runtime;message_generation")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 block_localization_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${block_localization_dep}_FOUND)
      find_package(${block_localization_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${block_localization_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(block_localization_INCLUDE_DIRS ${${block_localization_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(block_localization_LIBRARIES ${block_localization_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${block_localization_dep}_LIBRARIES})
  _list_append_deduplicate(block_localization_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(block_localization_LIBRARIES ${block_localization_LIBRARIES})

  _list_append_unique(block_localization_LIBRARY_DIRS ${${block_localization_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(block_localization_EXPORTED_TARGETS ${${block_localization_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "block_localization-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${block_localization_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
